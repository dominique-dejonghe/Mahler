...
export const ui = {
  ...
  lettersIntro: {
    nl: 'Mahler schreef duizenden brieven. Een complete teksteditie bestaat niet: ze zitten in 100+ boeken. De wetenschappelijke index (Mahler-Online, OeAW/IGMS) telt 2459 brieven van hem, plus antwoorden. Hier: de catalogus per correspondent, en 28 sleutelbrieven met Nederlandse samenvatting. Volledige teksten staan in de genoemde edities. Index: mahler-online.at.',
    en: 'Mahler schreef duizenden brieven. Een complete teksteditie bestaat niet: ze zitten in 100+ boeken. De wetenschappelijke index (Mahler-Online, OeAW/IGMS) telt 2459 brieven van hem, plus antwoorden. Hier: de catalogus per correspondent, en 28 sleutelbrieven met Nederlandse samenvatting. Volledige teksten staan in de genoemde edities. Index: mahler-online.at.',
    de: 'Mahler schreef duizenden brieven. Een complete teksteditie bestaat niet: ze zitten in 100+ boeken. De wetenschappelijke index (Mahler-Online, OeAW/IGMS) telt 2459 brieven van hem, plus antwoorden. Hier: de catalogus per correspondent, en 28 sleutelbrieven met Nederlandse samenvatting. Volledige teksten staan in de genoemde edities. Index: mahler-online.at.',
    cs: 'Mahler schreef duizenden brieven. Een complete teksteditie bestaat niet: ze zitten in 100+ boeken. De wetenschappelijke index (Mahler-Online, OeAW/IGMS) telt 2459 brieven van hem, plus antwoorden. Hier: de catalogus per correspondent, en 28 sleutelbrieven met Nederlandse samenvatting. Volledige teksten staan in de genoemde edities. Index: mahler-online.at.',
  },
  lettersIndex: {
  ...
  lettersCopyright: {
    nl: 'Mahlers eigen tekst is PD in de EU (dood 1911); moderne edities en apparaat blijven copyright; wij dumpen geen volledige teksten.',
    en: 'Mahlers eigen tekst is PD in de EU (dood 1911); moderne edities en apparaat blijven copyright; wij dumpen geen volledige teksten.',
    de: 'Mahlers eigen tekst is PD in de EU (dood 1911); moderne edities en apparaat blijven copyright; wij dumpen geen volledige teksten.',
    cs: 'Mahlers eigen tekst is PD in de EU (dood 1911); moderne edities en apparaat blijven copyright; wij dumpen geen volledige teksten.',
  },
  lettersEmpty: {
    nl: 'Geen brieven voor deze filters — index:',
    en: 'Geen brieven voor deze filters — index:',
    de: 'Geen brieven voor deze filters — index:',
    cs: 'Geen brieven voor deze filters — index:',
  },
  lettersEmptyPeople: {
    nl: 'Geen correspondenten voor deze filters — index:',
    en: 'Geen correspondenten voor deze filters — index:',
    de: 'Geen correspondenten voor deze filters — index:',
    cs: 'Geen correspondenten voor deze filters — index:',
  },
  ...
  catalogIntro: {
    nl: 'Alle symfonieën en cycli, gesorteerd op beginjaar. Zoek alle opnames en uitvoeringen.',
    en: 'All symphonies and cycles, sorted by first composition year. Search all recordings and performances.',
    de: 'Alle Sinfonien und Zyklen, sortiert nach Beginnjahr. Suche alle Aufnahmen und Aufführungen.',
    cs: 'Všechny symfonie a cykly podle roku začátku. Hledejte všechny nahrávky a provedení.',
  },
  listen: { nl: 'Beluisteren', en: 'Listen', de: 'Hören', cs: 'Poslouchat' },
  watch: { nl: 'Bekijken', en: 'Watch', de: 'Ansehen', cs: 'Sledovat' },
  spotifyAll: {
    nl: 'Spotify · alle opnames',
    en: 'Spotify · all recordings',
    de: 'Spotify · alle Aufnahmen',
    cs: 'Spotify · všechny nahrávky',
  },
  youtubeAll: {
    nl: 'YouTube · alle uitvoeringen',
    en: 'YouTube · all performances',
    de: 'YouTube · alle Aufführungen',
    cs: 'YouTube · všechna provedení',
  },
  after1911: {
